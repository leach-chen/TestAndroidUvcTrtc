...
public class Camera2Service extends Service {
    ...
    class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Log.d("mytest","vvvvvvvvvvvvvvvvvvvvvvvvvv");
            switch (msg.what) {
                case MSG_SAY_HELLO:
                    //Toast.makeText(getApplicationContext(), "helloaaaaaaaaaaaaaaabbbbbbbbbbb", Toast.LENGTH_SHORT).show();
                    updateData(msg.getData().getByteArray("key1"));
                    break;
                default:
    ...
    public class MsgBinder extends Binder {
         ...
         * @return
         */
        public Camera2Service getService() {
    ...
    {
        Log.d("mytest","aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa11111111111111");
